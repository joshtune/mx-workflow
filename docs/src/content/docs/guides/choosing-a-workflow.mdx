...
For trivial changes where you already know what to do, make the edit and use `/mx:ship` to validate, commit, and push in one step.
...
```
/mx:ship "fix typo in error message"
```
